...
VALUES
	...
	(3,1,'26','Electronics','product','Acer Ferrari 3200 Notebook Computer PC','http://magento.shoppul.se/index.php/acer-ferrari-3200-notebook-computer-pc.html','http://magento.shoppul.se/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/a/c/acer-ferrari-3200-notebook-computer-pc.jpg','This exclusive edition is another striking symbol of cooperation between Acer and Ferrari -- two progressive companies with proud heritages built on passion, innovation, power and success.',0,'2012-08-15 15:23:16');
